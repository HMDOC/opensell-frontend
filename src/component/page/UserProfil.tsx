...
export default function UserProfil(props: {
  ...
  useEffect(() => {
    getCustomerProfil(props.isMyProfil ? props.loggedUserLink : link).then(
      (res) => {
        ...
        <div className="top-div">
          <div className="pfp-div">
            <img
              className="pfp"
              src={
                customerProfil?.customerInfo?.iconPath
                  ? getCustomerIconUrl(customerProfil?.customerInfo?.iconPath)
                  : NO_PROFILE_ICON
              }
              alt="user-profil"
            />
          ...
          <div className="info-div">
            ...
            >
              ...
              >
                Since {customerProfil?.joinedDate?.split("-")[0]}
              </span>
            </div>
