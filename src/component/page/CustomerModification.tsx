...
import {
  ...
  CMProperties,
  CMState,
} from "../../services/customerModification/CMComponents";
import {
  CMBasicModificationsForm,
  CMIconForm,
  CMPasswordForm,
  CMPersonalEmailForm,
  CMPhoneNumberForm,
} from "../../services/customerModification/CMForm";
 ...
 *
 */
export default class CustomerModification extends Component<
  CMProperties,
  CMState
> {
  ...
  public openModal(type: CMModalType): void {
    if (type == CMModalType.BASIC_CHANGES)
      this.setState({
        currentModalContent: (
          <CMBasicModificationsForm
            defaultValues={this.props.customerData}
            closeModalCallback={() => this.closeModal()}
          />
        ),
      });
    else if (type == CMModalType.PERSONNAL_EMAIL)
      this.setState({
        currentModalContent: (
          <CMPersonalEmailForm
            defaultValues={this.props.customerData}
    ...
    else if (type == CMModalType.PASSWORD)
      this.setState({
        currentModalContent: (
          <CMPasswordForm
            defaultValues={this.props.customerData}
    ...
    else if (type == CMModalType.PHONE_NUMBER)
      this.setState({
        currentModalContent: (
          <CMPhoneNumberForm
            defaultValues={this.props.customerData}
            ...
            <div className="input-div">
              ...
              <span style={{ fontSize: "1vw" }}>
                <CMDisplay
                  ...
                  defaultValue={this.props.customerData.personalEmail}
                />
              </span>
              <CMDisplay
                labelText="Password"
                hasButton={true}
                buttonOnClickCallback={() =>
                  this.openModal(CMModalType.PASSWORD)
                }
                isPassword={true}
              />
              <CMDisplay
                ...
                defaultValue={this.props.customerData.customerInfo?.phoneNumber}
              />
            </div>
          </div>
          <div className="CM-Container">
            <div className="input-div">
              <div className="CM-Title-Button-Container">
                ...
                <div className="change-button">
                  <button
                    type="button"
                    onClick={() => this.openModal(CMModalType.BASIC_CHANGES)}
                    className="modificationLabel"
                  >
                    Change
                  </button>
                </div>
              ...
              <CMDisplay
                labelText="Bio"
                defaultValue={this.props.customerData.customerInfo?.bio}
              />
            </div>
          </div>
          <div className="CM-Container">
              ...
              <div className="CM-Title-Button-Container">
                ...
                <div style={{ border: "none" }} className="change-button">
                  ...
                  <button
                    ...
                    className="modificationLabel"
                    onClick={() => this.openModal(CMModalType.ICON)}
                  >
                    Change
                  </button>
                </div>
