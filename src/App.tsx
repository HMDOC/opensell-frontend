...
const CustomerModification = lazy(
  () => import("./component/page/CustomerModification"),
);
    ...
    <BrowserRouter>
      <Suspense fallback={<LazyLoad />}>
        <GlobalNavBar
          ...
          logout={() => setCustomerDto(undefined)}
        />
        <Routes>
          <Route path="/u" element={<PrivateRoute />}>
            <Route
              path="/u/my-ads"
              element={<MyAds idCustomer={customerDto?.customerId} />}
            />
            <Route
              path="/u/ad-modification/:link"
          ...
          <Route
            ...
            element={
              customerDto ? (
                ...
                <Signup getCustomerInfo={getCustomerInfo} />
              )
            }
          ></Route>
          <Route
            ...
            element={
              customerDto ? (
                ...
                <Login getCustomerInfo={getCustomerInfo} />
              )
            }
          ></Route>
